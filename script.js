document.addEventListener('DOMContentLoaded', function () {
  ...
  const ANIMATION_SELECTORS = '.animate-on-scroll, .fade-in, .slide-in, [data-animate]';

  function initScrollAnimations() {
    const animatableEls = document.querySelectorAll(ANIMATION_SELECTORS);
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '4bf79ea5-d329-479b-b884-065800e65204',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '4bf79ea5-d329-479b-b884-065800e65204';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '4bf79ea5-d329-479b-b884-065800e65204';
